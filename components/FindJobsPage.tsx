    ...
    <div className="min-h-screen bg-white">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-[#F6F6F6] text-black placeholder:text-black rounded-3xl focus:outline-none"
                >
                  <option className='bg-white' value="">All Categories</option>
                  {categories.map(category => (
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-[#f8fafc]">
        ...
        <div className="mt-4 border-t-2 pt-4">
          ...
          {["Entry-level", "Mid-level", "Senior-level", "Executive"].map((exp) => (
            <label key={exp} className="flex items-center p-2 rounded-lg hover:bg-[#FAFAFA] cursor-pointer">
              <input
                type="radio"
                name="experience"
                checked={filters.experience === exp}
    ...
    {/* Sidebar Filters - Desktop */}
          ...
          <div className="lg:w-3/4">
            ...
            <section className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 bg-[#f8fafc]'>
              {filteredJobs.map((job) => (
                <div key={job._id} className='w-full bg-white rounded-2xl border p-2'>
                  <div className='flex border-b pb-4'>
                  <div className='w-14 h-14 rounded-xl border flex justify-center items-center px-1'>
                    <img className={job?.company?.logo ? "block" : 'hidden'} src={job?.company?.logo} alt='company logo'/>
                  </div>
                  <div className='ms-2'>
                  ...
                  <div className='flex justify-between items-center mt-6 pb-2 px-2'>
                    <button onClick={() => router.push(`/jobs/${job._id}`)} className='px-4 py-1 border rounded-3xl text-[#6D47F1]'>Apply Now</button>
