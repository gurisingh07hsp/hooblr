        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-lg mb-6 text-[#8A38EE] max-w-3xl mx-auto leading-relaxed">
              Expert advice, industry trends, and practical tips to accelerate
              your career growth
            </p>
            ...
            <div className="mb-10">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Our most popular and highly-rated articles to help you advance
                  your career
                </p>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {featuredPosts.map((post) => (
                  <article
                    key={post._id}
                    className="group bg-white/80 backdrop-blur-sm rounded-xl border border-purple-200 overflow-hidden transition-all duration-300 transform hover:-translate-y-1"
                  >
                    {post.featuredImage && (
                    ...
                    <div className="p-5">
                      <div className="flex items-center space-x-2 mb-3">
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-bold rounded-full bg-gradient-to-r ${getCategoryColor(
                            post.category
        ...
        <div className="mt-20 bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 rounded-3xl p-12 text-white relative overflow-hidden">
          ...
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            <p className="text-purple-100 mb-8 text-lg max-w-xl mx-auto">
              Get the latest career advice, industry trends, and job search tips
