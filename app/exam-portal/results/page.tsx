...
export default function ExamResultsPage() {
  ...
  const notifications = [
    { title: "Punjab Police Constable Result 2026 Declared", date: "June 28, 2024", isNew: true },
    { title: "SBI PO Mains Result 2024 Out", date: "June 25, 2024", isNew: true },
    { title: "SSC CHSL Tier 1 Result 2024 Soon", date: "June 20, 2024", isNew: false },
    { title: "RRB NTPC Final Merit List 2024", date: "June 15, 2024", isNew: false },
  ];

  const recentResults = [
    {
      examName: "Punjab Police Constable Result 2026",
      rollNo: "PP2026014523",
      examDate: "15th July 2026",
      resultDate: "28th August 2026",
      status: "Qualified",
      marks: 142,
      totalMarks: 200,
      percentile: 94.2,
    ...
    {
      examName: "SBI PO Prelims Result 2024",
      rollNo: "SBI2024120089",
      examDate: "20th July 2024",
      resultDate: "10th August 2024",
      status: "Qualified",
      marks: 78,
      totalMarks: 100,
      percentile: 89.7,
  ...
  const importantLinks = [
    ...
    { text: "Final Merit List", icon: Trophy },
    { text: "Cut Off Marks", icon: TrendingUp },
    { text: "Score Card", icon: Award },
  ];
  ...
  const resultDetails = [
    ...
    { label: "Result Status", value: "Declared" },
    { label: "Total Vacancies", value: "1746 Posts" },
    { label: "Official Website", value: "punjabpolice.gov.in" },
  ];

  const stepsToCheck = [
    "Visit the official website of Punjab Police at punjabpolice.gov.in",
    "Click on the 'Results' or 'Recruitment' tab on the homepage",
    "Find the link for 'Punjab Police Constable Result 2026'",
  ...
  const cutoffMarks = [
    ...
    { category: "OBC", cutoff: 118 },
    { category: "SC", cutoff: 105 },
    { category: "ST", cutoff: 98 },
    { category: "EWS", cutoff: 115 },
  ];
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="text-center">
              ...
              <h1 className="text-3xl flex justify-center items-center md:text-4xl font-bold text-black mb-4">
                <span className='lg:text-4xl text-3xl text-[#8A38EE]'>Punjab Police</span> Constable Result 2026
              </h1>
              <p className="text-lg mb-6 text-black max-w-3xl mx-auto leading-relaxed">
                Check Punjab Police Constable Result 2026 declared on 28th August 2026. Download scorecard, check cutoff marks, and final merit list here.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="sticky top-6 space-y-6">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl border p-6">
                  ...
                  <ul className="space-y-3 text-sm text-gray-600">
                    <li className="hover:text-[#8A38EE] cursor-pointer transition-colors">Forgot Roll Number?</li>
