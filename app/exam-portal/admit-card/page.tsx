          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="text-center">
              ...
              <h1 className="text-3xl flex justify-center items-center md:text-4xl font-bold text-black mb-4">
                <span className='lg:text-4xl text-3xl text-[#8A38EE]'>Punjab Police</span> Constable Admit Card 2026
              </h1>
              <p className="text-lg mb-6 text-black max-w-3xl mx-auto leading-relaxed">
                Download Punjab Police Constable Admit Card 2026 for the exam scheduled on 15th July 2026. Check exam date, time, venue, and important instructions here.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:w-3/4 space-y-12">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-purple-200 lg:p-6 p-3">
                <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  ...
                  Steps to Download Punjab Police Admit Card 2026
                </h2>
